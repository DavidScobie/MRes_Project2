...
patient_code = 'GOSH_full_set_var_temp_len_val1x_and_y_without_aug'
...
full_filepath = os.path.join("C:/PHD/MRes_project/ML_work/read_DICOMS/data/GOSH_SAX_data/GOSH_full_set_var_temp_len_val_a_few/non_aug/",patient_code)
...
sio.savemat('GOSH_non_aug_var_fram_size_LR0p0001_70epo_GOSH_full_set_var_temp_len_val1x_and_y_without_aug.mat',{'x':x_np, 'y':y_np, 'y_pred':ypred_np}) #you can save as many arrays as you want