...
patient_code = 'GOSH_full_set_var_temp_len_val1x_and_y_trans_aug_only_ex1'

full_filepath = os.path.join("C:/PHD/MRes_project/ML_work/read_DICOMS/data/GOSH_SAX_data/GOSH_variable_trans_level_x_and_y_val1/",patient_code)
...
model = load_model('../../read_DICOMS/frames_40/dlex_augment/GOSH_non_aug_var_fram_size_same_trans_only_bs4/best_var_fram_size.h5')
...
sio.savemat('GOSH_non_aug_var_fram_size_same_trans_only_bs4_GOSH_full_set_var_temp_len_val1x_and_y_trans_aug_only_ex1.mat',{'x':x_np, 'y':y_np, 'y_pred':ypred_np}) #you can save as many arrays as you want