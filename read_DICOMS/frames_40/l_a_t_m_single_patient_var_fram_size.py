...
sio.savemat('GOSH_non_aug_var_fram_size_same_RHR_as_MAT_check_NaNs_GOSH_full_set_var_temp_len_val1x_and_y_RHR_aug_only_ex0.mat',{'x':x_np, 'y':y_np, 'y_pred':ypred_np}) #you can save as many arrays as you want